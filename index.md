...
Binary image thinning (skeletonization) algorithms for R. Designed as a
drop-in replacement for `EBImage::thinImage()` with additional
algorithms behind a single dispatching function.
