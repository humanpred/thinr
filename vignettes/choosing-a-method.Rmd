...
`zhang_suen` is the default. The `thinImage()` wrapper is a convenience alias for `thin(method = "zhang_suen")`.
...
- **`zhang_suen`** — the default. Most predictable behavior. Use for general purpose thinning; also available under the `thinImage()` alias.
